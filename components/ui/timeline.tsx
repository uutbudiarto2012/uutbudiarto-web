      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-myprimary-light border border-white/20 p-2" />
              </div>
              <h3 className="hidden md:block text-2xl md:pl-20 md:text-5xl font-bold  leading-tight bg-gradient-to-r from-myprimary-light via-myprimary-superlight to-myprimary text-transparent bg-clip-text">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-myprimary-light via-myprimary-superlight to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
